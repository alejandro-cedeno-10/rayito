...
- **THEN** the loaded records equal the saved ones, no `<path>.tmp` remains, the mode is `0o600`, and the file text contains both tokens and the `schema` key
